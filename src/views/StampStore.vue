            ...
            <div class="stamp-list" v-for="stamp in filtered(search)" v-bind:key="stamp.title">
                <div class="stamp">
                    ...
                    <div class="price">
                        {{stamp.point}} Pt
                        <!-- TODO: 引数のIDをどう指定するか？ -->
                        <input type="button" class="buy-btn" value="購入する" v-on:click="buy(stamp, '3')">
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    data: ()=> {
        return {
            ...
            stamps: [
                ...
                {author: "piyo", title: "やらかした人シリーズ", point: 10, image: require("../assets/coffee_kobosu.png")},
    ...
    methods: {
        ...
        buy: (stamp, id) =>{
            ...
            fetch("https://91ss8vtva7.execute-api.ap-northeast-1.amazonaws.com/mytubeapi?id=" + id)
                .then(response => {
